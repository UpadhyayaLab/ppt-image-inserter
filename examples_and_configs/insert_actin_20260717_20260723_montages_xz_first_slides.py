"""
insert_actin_20260717_20260723_montages_xz_first_slides.py

XZ-first ordering variant of insert_actin_20260717_20260723_montages_slides.py.
Same 2-expt CAT-vs-FMC side-by-side layout, different KINDS order:

    Slides  1- 8: Actin XZ MIP                        (raw axial)
    Slides  9-16: Actin Axial Profile            (axial total signal)
    Slides 17-24: Actin: 0, 2, and 4 slices above synapse      (bottom_slices_xy raw)
    Slides 25-32: Actin at Synapse                    (segmented 1slice mask)
    Slides 33-40: IRM Segmentation                    (coverslip-contact seg)
...
Usage:
    python examples_and_configs/insert_actin_20260717_20260723_montages_xz_first_slides.py
"""
...
OUTPUT_PATH = (
    ...
    "CART_actin_montages_20260717_20260723_xz_first.pptx"
)
