"""
insert_nuc_lamin_MT_slides.py

Iterates through condition subdirectories and inserts one
fixed_slice_montage_nuc_lamin_merge image per blank slide into a new
presentation. The first slide of the source PPT (title/cover) is copied
over; all remaining slides are newly added blank slides with a centered
title and the montage image.

Positions are rough defaults — adjust manually in PowerPoint afterwards.

Usage:
    python examples_and_configs/insert_nuc_lamin_MT_slides.py
"""
...
PPT_PATH = (
    ...
    "Ctrl_DZNep_upto1hr_XZMIP_montages_nuc_lamin_MT_template.pptx"
)
...
# Glob pattern for the lamin/MT merge montage
