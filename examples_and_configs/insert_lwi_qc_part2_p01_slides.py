"""
insert_lwi_qc_wrinkles_p01_slides.py

Generate a wrinkle-metrics QC deck from the LWI_QC
Montages_filter_pp_load directory under prog_lwi_swi_only.
For each lmnb1 condition subdirectory, builds one slide with a
2x2 grid of the four p01 wrinkle-metric montages:
...
Companion to insert_lwi_qc_views_p01_slides.py — same layout / source
directory, different IMAGE_KINDS and output filename.

Usage:
    python examples_and_configs/insert_lwi_qc_wrinkles_p01_slides.py
"""
...
OUTPUT_PATH = (
    ...
    "Ctrl_DZNep_upto1hr_LWI_QC_part2_LaminB1_p01.pptx"
)
...
# New minimal-pipeline output dir.
...
IMAGE_KINDS = [
    ("LWI",           "Montage_LWI_LaminB1_p01.png"),            # TL
    ("SWI",           "Montage_SWI_LaminB1_p01.png"),            # TR
    ("Heatmap (LWI)", "Montage_Heatmap_LaminB1_p01.png"),        # BL
    ("Heatmap (SWI)", "Montage_Heatmap_SWI_LaminB1_p01.png"),    # BR
]
