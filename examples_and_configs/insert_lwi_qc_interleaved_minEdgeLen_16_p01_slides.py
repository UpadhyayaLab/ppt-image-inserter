"""
insert_lwi_qc_interleaved_minEdgeLen_16_p01_slides.py

Interleaved part1 + part2 LWI_QC deck reading from the minEdgeLen=16
rerun of the prog_lwi_swi_only pipeline.

For each lmnb1 condition subdirectory, builds TWO slides back-to-back:
...
Result: 10 conditions × 2 slides = 20 slides total.

Source dir: cropped/channels/prog_lwi_swi_only_minEdgeLen_16/LWI_QC/Montages_filter_pp_load/

Companion to insert_lwi_qc_interleaved_p01_slides.py (minEdgeLen=10 version).

Usage:
    python examples_and_configs/insert_lwi_qc_interleaved_minEdgeLen_16_p01_slides.py
"""
...
OUTPUT_PATH = (
    ...
    "Ctrl_DZNep_upto1hr_LWI_QC_interleaved_minEdgeLen_16_LaminB1_p01.pptx"
)
