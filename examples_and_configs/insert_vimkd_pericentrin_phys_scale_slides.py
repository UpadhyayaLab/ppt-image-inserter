"""
insert_vimkd_pericentrin_phys_scale_slides.py

siCtrl (left) vs siVim / vimentin-knockdown (right) physical-scale montage deck
for the fixed Jurkat VimentinKD pericentrin experiments
(config/datasets/fixed/Jurkats/VimentinKD). Copied from
...
Three pericentrin/centrosome experiments (siCtrl vs siVim, chronological):
  - 04/06/2022
  - 05/20/2022   (48h aCD3)
  - 06/28/2022   (48h aCD3)
chan_sub is "cells/individual-channels" for all. Channels: actin / pericentrin
(centrosome) / nucleus -- there is no vimentin channel (vim is the knockdown
target), so the deck is marker-agnostic and the siCtrl-vs-siVim columns carry the
comparison. (The 20220628 C1/C2 actin/cent order is swapped upstream; combos are
named by channel role, so no impact here.)
...
OUTPUT_PATH = (
    ...
    "VimKD_Jurkats_siCtrl_vs_siVim_pericentrin_phys_scale_montages.pptx"
)
...
EXPERIMENTS = [
    {
        ...
        "root": (
            ...
            "VimentinKD_NucleusData_Fixed/20220406 - Vimentin siRNA Experiments/Pericentrin"
        ),
    ...
    },
    {
        ...
        "root": (
            "M:/FF/FF_4TB_2_Backup_fullHD/Vimentin_Project_2ndharddrive/"
            "VimentinKD_NucleusData_Fixed/20220519 - Vimentin siRNA Experiments/"
            "20220520 - Vim KD Pericentrin"
        ),
        "chan_sub": "cells/individual-channels",
        "left":  ("E6-1_siCtrl_48h_aCD3_Pericentrin", "siCtrl"),
        "right": ("E6-1_siVim_48h_aCD3_Pericentrin",  "siVim (KD)"),
        "tp_label": "48h αCD3",
    },
    {
        "tag": "06/28/2022",
        "root": (
            "M:/FF/FF_4TB_2_Backup_fullHD/Vimentin_Project_2ndharddrive/"
            "VimentinKD_NucleusData_Fixed/20220628 - Vimentin siRNA Experiments/"
            "20220628 - Vim KD Pericentrin"
        ),
        "chan_sub": "cells/individual-channels",
        "left":  ("E6-1_siCtrl_tf2_48h_aCD3_Pericentrin", "siCtrl"),
        "right": ("E6-1_siVim_tf2_48h_aCD3_Pericentrin",  "siVim (KD)"),
        "tp_label": "48h αCD3",
    },
]
