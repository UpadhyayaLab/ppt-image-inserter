"""
insert_xymip_nuc_lamin_slides.py

Generate the XY-MIP nucleus + lamin merge montage deck from a styled
...
condition's XY-MIP montage, and the title textbox text is replaced in
place (preserving the template's font, size, color, alignment).

Companion to insert_nuc_lamin_MT_slides.py, which targets the
broadest-slice (fixed_slice_images) montages. Title formatting comes
from the template rather than being generated from scratch.

Usage:
    python examples_and_configs/insert_xymip_nuc_lamin_slides.py
"""
...
TEMPLATE_PATH = (
    ...
    "Ctrl_DZNep_upto1hr_XYMIP_montages_nuc_lamin_template.pptx"
)
...
MONTAGE_SUBPATH = "cropped/xy_mip_images/montages_nuc_lamin_merge"
IMAGE_GLOB = "xy_mip_montage_nuc_lamin_merge_*.png"
