"""
insert_lwi_qc_part2_minEdgeLen_16_p01_slides.py

Part 2 (LWI / SWI / Heatmap_LWI / Heatmap_SWI) QC deck reading from
the minEdgeLen=16 rerun of the prog_lwi_swi_only pipeline.
...
Companion to insert_lwi_qc_part2_p01_slides.py (minEdgeLen=10 version).

Usage:
    python examples_and_configs/insert_lwi_qc_part2_minEdgeLen_16_p01_slides.py
"""
...
OUTPUT_PATH = (
    ...
    "Ctrl_DZNep_upto1hr_LWI_QC_part2_minEdgeLen_16_LaminB1_p01.pptx"
)
