...
FAMILIES = [
    ...
    # Granule (LAMP1) and MT localization near nuclear invaginations — depth
    ...
    # {Lamp1,MT}_loc_wrto_invag/. Each slide pairs LAMP1 and MT for one
    # geometry axis (hull distance / min curvature / mean curvature).
    ("Granules and MT — localization vs invagination geometry", [
        ...
        ([("Lamp1_loc_wrto_invag/03b_Lamp1_enrichment_hulldist_gt1.0um.png", "LAMP1"),
          ("MT_loc_wrto_invag/03b_MT_enrichment_hulldist_gt1.0um.png",       "MT")],
         "Enrichment in deep invaginations (hulldist > 1.0 μm)"),
        ([("Lamp1_loc_wrto_invag/03c_Lamp1_enrichment_minCurvature_lt0.png", "LAMP1"),
          ("MT_loc_wrto_invag/03c_MT_enrichment_minCurvature_lt0.png",       "MT")],
         "Enrichment on concave surface (min curv < 0)"),
        ([("Lamp1_loc_wrto_invag/03d_Lamp1_enrichment_minCurvature_ltm0.25.png", "LAMP1"),
          ("MT_loc_wrto_invag/03d_MT_enrichment_minCurvature_ltm0.25.png",       "MT")],
         "Enrichment on strongly concave surface (min curv < −0.25)"),
        ([("Lamp1_loc_wrto_invag/03e_Lamp1_enrichment_meanCurvature.png", "LAMP1"),
          ("MT_loc_wrto_invag/03e_MT_enrichment_meanCurvature.png",       "MT")],
         "Enrichment vs mean curvature"),
        ([("Lamp1_loc_wrto_invag/04a_Lamp1_correlation_hulldist.png", "LAMP1"),
          ("MT_loc_wrto_invag/04a_MT_correlation_hulldist.png",       "MT")],
         "Per-cell correlation vs hull distance"),
        ([("Lamp1_loc_wrto_invag/04b_Lamp1_correlation_minCurvature.png", "LAMP1"),
          ("MT_loc_wrto_invag/04b_MT_correlation_minCurvature.png",       "MT")],
         "Per-cell correlation vs min curvature"),
        ([("Lamp1_loc_wrto_invag/04c_Lamp1_correlation_meanCurvature.png", "LAMP1"),
          ("MT_loc_wrto_invag/04c_MT_correlation_meanCurvature.png",       "MT")],
         "Per-cell correlation vs mean curvature"),
    ]),
]
...
def _panel_path(stem):
    ...
    Paths starting with one of the EXTRA_ROOT_PREFIXES route to EXTRA_ROOT so
    the invag_depth_profiles/ and *_loc_wrto_invag/ families can source from
    the newer (non-QC-filtered) compile that emits them."""
    if stem.endswith(".png"):
        if stem.startswith(EXTRA_ROOT_PREFIXES):
            return EXTRA_ROOT / stem
        return ROOT / stem
