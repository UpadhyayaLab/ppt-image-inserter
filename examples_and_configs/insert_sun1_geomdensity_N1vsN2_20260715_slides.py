"""
insert_sun1_geomdensity_N1vsN2_20260715_slides.py
...
Usage:
    conda run -n PPT_editing python examples_and_configs/insert_sun1_geomdensity_N1vsN2_20260715_slides.py
    conda run -n PPT_editing python examples_and_configs/insert_sun1_geomdensity_N1vsN2_20260715_slides.py --list
"""
...
OUTPUT_PATH = Path(
    ...
    "SUN1 vs NE geometry, N1 vs N2 (20260715).pptx"
)
